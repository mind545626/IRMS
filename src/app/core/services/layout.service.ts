...
const store = {
  ...
  skins: config.skins,
  fixedHeader: config.fixedHeader ? config.fixedHeader : localStorage.getItem('sm-fixed-header') == 'true',
  fixedNavigation: config.fixedNavigation ? config.fixedNavigation : localStorage.getItem('sm-fixed-navigation') == 'true',
  fixedRibbon: config.fixedRibbon ? config.fixedRibbon : localStorage.getItem('sm-fixed-ribbon') == 'true',
  fixedPageFooter: config.fixedPageFooter ? config.fixedPageFooter : localStorage.getItem('sm-fixed-page-footer') == 'true',
  insideContainer: config.insideContainer ? config.insideContainer : localStorage.getItem('sm-inside-container') == 'true',
  rtl: localStorage.getItem('sm-rtl') == 'true',
  menuOnTop: config.menuOnTop ? config.menuOnTop : localStorage.getItem('sm-menu-on-top') == 'true',
